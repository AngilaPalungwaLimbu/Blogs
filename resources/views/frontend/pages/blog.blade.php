            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="frontend/assets/img/post-landscape-1.jpg" alt=""
                                class="img-fluid"></a>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src={{asset($startup->image)}}
                                        alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">{{$startup->category}}</span> <span
                                        class="mx-1">&bullet;</span> <span>{{$startup->date}}</span></div>
                                <h2><a href="single-post.html">{{$startup->title}}</a></h2>
                            </div>
                            <div class="post-entry-1">
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="frontend/assets/img/post-landscape-8.jpg"
                                        alt="" class="img-fluid"></a>
